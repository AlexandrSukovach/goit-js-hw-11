...
export default class NewsApiService {
   ...
   async fetchArticles() {
      // =================axios===================
      const response = await axios.get(`https://pixabay.com/api/?key=25024610-b715c2d32e80bfb8f3c0998cb&image_type=photo&orientation=horizontal&safesearch=true&q=${this.searchQuery}&per_page=${this.pageLength}&page=${this.page}`)
